...
which is quite responsive in practice</source>
            <translation>Время бездействия между обработкой звуковых данных по записи.
Нулевое значение делает приложение более интерактивным за счёт использования процессора.
Значением по умолчанию является 0.1 (обработка 10 раз в секунду), — достаточно живо для реальных задач</translation>
        </message>
        <message>
...
<context><name>AdvancedUI</name><message><source>Global shortcut: Toggle</source><translation>Глобальное сочетание: Переключить</translation></message><message><source>Global keyboard shortcut to toggle dictation (KDE only)</source><translation>Глобальное сочетание клавиш для переключения диктовки (только KDE)</translation></message></context></TS>